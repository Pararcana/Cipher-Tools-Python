...
changes = {}
for key in permutations(choices, 5):
  buffer = []
  for block in ciphertext:
    for v in key:
      buffer.append(block[v])
  changes.update({fitness(buffer): buffer})

print("".join(changes[max(changes.keys())]))
